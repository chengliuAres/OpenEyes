...
- (void)layoutSubviews
{
    ...
    /** 信息 */
    self.messageLabel.frame = CGRectMake(0,CGRectGetMaxY(_titleLabel.frame),self.bounds.size.width - 10, 25);
    
    self.topLine.frame = CGRectMake(ScreenWidth/2 - 15,CGRectGetMaxY(_messageLabel.frame) + 20, 30, 0.5);
    
    self.indexLabel.frame = CGRectMake(ScreenWidth/2 - 30, CGRectGetMaxY(_topLine.frame) + 5, 60, 15);
    
    self.bottomLine.frame = CGRectMake(ScreenWidth/2 - 15, CGRectGetMaxY(_indexLabel.frame)+ 3, 30, 0.5);
}
@end
